...
Source0  : https://download.kde.org/stable/frameworks/5.97/portingAids/kxmlrpcclient-5.97.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.97/portingAids/kxmlrpcclient-5.97.0.tar.xz.sig
...
%prep
%setup -q -n kxmlrpcclient-5.97.0
cd %{_builddir}/kxmlrpcclient-5.97.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660578087
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5XmlRpcClient.so.5.97.0
