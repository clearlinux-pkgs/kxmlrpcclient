...
Source0  : https://download.kde.org/stable/frameworks/5.59/kxmlrpcclient-5.59.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.59/kxmlrpcclient-5.59.0.tar.xz.sig
...
%prep
%setup -q -n kxmlrpcclient-5.59.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1560036090
mkdir -p clr-build
pushd clr-build
export AR=gcc-ar
...
/usr/lib64/libKF5XmlRpcClient.so.5.59.0
